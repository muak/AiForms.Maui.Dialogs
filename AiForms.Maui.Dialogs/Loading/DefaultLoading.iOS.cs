...
public class DefaultLoading:LoadingBase
{
    ...
    void Initialize(bool isCurrentScope = false)
    {
        ...
        OverlayView.BackgroundColor = _config.OverlayColor.ToPlatform();
        ...
        _messageLabel.TextColor = _config.FontColor.ToPlatform();
        _messageLabel.Font = _messageLabel.Font.WithSize((NFloat)_config.FontSize);
